...
class MetricCalculator:
    ...
    def calculate_portfolios(self) -> Tuple[np.ndarray, np.ndarray, float, float]:
        """
        ...
        """
        # self.logdir = '/tmp/pycharm_project_385/finol/SAPP_PAPER_RESULTS/' + self.config["DATASET_NAME"] + '/SAPP'
